...
public class SceneView extends JPanel implements Scene.Listener{
    ...
    public SceneView(PlayerResources s, int sceneNum){
	super(null);
	setLayout(null);
  ...
  public void showScene(Scene s){
    System.out.println("Inside SceneView");
    ...
    scene.setIcon(r.getIcon(3, 2));
    scene.setBounds(s.getArea().get(0), s.getArea().get(1), s.getArea().get(2), s.getArea().get(3));
    }
